 ...
 */
class ResCollection {
  private collection: Map<string, Response>;
  ...
  public getEntryFromCollection(id: string): Response | undefined {
  ...
  public addToCollection(id: string, res: Response) {
  ...
  public doForAllResInCollection(functionToExecute: (arg: Response, arg2?: string[]) => void) {
    this.doMultipleForAllResInCollection([functionToExecute]);
  }

  public doMultipleForAllResInCollection(functionsToExecute: ((arg: Response) => void)[]) {
    log.debug(
