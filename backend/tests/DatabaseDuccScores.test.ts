...
Current behavior with testing below will INSERT data into the PRODUCTION
database which we do not want. We will need to either create a testing database
or make mocks/stubs to test. 

*/

// test('parse scores correctly based off of friend or killer', async () => {
//   const mockFriendScoresMsg =
//     ':gonzobot!gonzo@snoonet/bot/gonzobot PRIVMSG #aboftytest :(aboft) Duck friend scores in #aboftytest: a​bofty: 1,777 • a​boft: 13213 • Asmodean: 6,9,49';
//   const mockKillerScoresMsg =
//     ':gonzobot!gonzo@snoonet/bot/gonzobot PRIVMSG #aboftytest :(aboft) Duck killer scores in #aboftytest: a​smodean: 1 • a​boft: 13213 • Asmodean: 6,9,49';
